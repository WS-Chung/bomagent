    ...
    >
      <div className="rounded-2xl glass p-4 sm:p-5 space-y-3">
        <p className="text-[12px] uppercase tracking-[0.18em] text-brand-300 font-semibold">
          구매팀이 실제로 해야 하는 판단 (Ideal)
        </p>
        <BlockFlow
          items={[
            { num: "01", title: "동일 사양 대체품 탐색", sub: "Cost-down 소싱" },
            { num: "02", title: "Preferred Vendor 확인", sub: "SCM · AVL" },
            { num: "03", title: "L/T · MOQ 재확인", sub: "발주 타이밍 결정" },
            { num: "04", title: "발주 · 납기 트래킹", sub: "PO 발행 · 팔로업" },
          ]}
        />
      </div>
      ...
      <CardGrid cols={3}>
        <Card title="가격 이외의 결정 변수" accent="brand">
          <ul className="list-disc pl-4 space-y-1">
            <li>설계 용이성(Design-in Support)</li>
            <li>공급사 기술지원(FAE)</li>
            <li>호환성 · Rev 관리 · EOL 리스크</li>
            <li>세관 · 결제 · 인증(REACH/RoHS)</li>
          </ul>
        </Card>
        <Card title="부품 클래스별 이질성" accent="amber">
          <ul className="list-disc pl-4 space-y-1">
            <li><b>수동 소자</b>: MOQ 릴 단위, 낮은 단가</li>
            <li><b>능동 소자</b>: 대리점 유통, 배분·할당</li>
            <li><b>기구/커넥터</b>: 커스터마이즈 · 도면 검증</li>
          </ul>
        </Card>
        <Card title="벤더 다변화의 부작용" accent="brand">
          부품마다 취급 업체가 다르고, 결제 조건과 납기가 다르다. 구매 담당자는{" "}
          <b>수십 개의 상이한 소싱 경로</b>를 동시에 관리해야 한다.
        </Card>
      </CardGrid>

      <div className="rounded-2xl glass p-4 sm:p-5 space-y-3">
        <p className="text-[12px] uppercase tracking-[0.18em] text-brand-300 font-semibold">
          현장에서 실제 관찰되는 패턴 (As-Is)
        </p>
        <BlockFlow
          items={[
            {
      ...
      <Callout variant="danger" title="영세 사업장의 구조적 딜레마">
